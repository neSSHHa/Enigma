...
namespace Enigma.Areas.Identity.Pages.Account
{
    [Area("Identity")]
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [Display(Name = "Terms & Conditions and Privacy Policy")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (!_roleMenager.RoleExistsAsync(StaticDetails.AdminRole).GetAwaiter().GetResult()) // seed it
            {
                await _roleMenager.CreateAsync(new IdentityRole(StaticDetails.AdminRole));
                await _roleMenager.CreateAsync(new IdentityRole(StaticDetails.MemberRole));
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _userManager.AddToRoleAsync(user, StaticDetails.MemberRole);
              ...
              ViewData["Error"] = "Error, please check information and try again";
